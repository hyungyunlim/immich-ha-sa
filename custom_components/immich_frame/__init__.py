        ...
        schema=vol.Schema(
            {
                ...
                vol.Optional("weatherShowForecast"): vol.In(["inherit", "true", "false"]),
                vol.Optional("weatherShowHumidity"): vol.In(["inherit", "true", "false"]),
                vol.Optional("weatherShowWind"): vol.In(["inherit", "true", "false"]),
                vol.Optional("weatherShowWindDirection"): vol.In(["inherit", "true", "false"]),
                vol.Optional("weatherShowVisibility"): vol.In(["inherit", "true", "false"]),
                vol.Optional("weatherShowTemperatureRange"): vol.In(["inherit", "true", "false"]),
                vol.Optional("weatherRoundTemperature"): vol.In(["inherit", "true", "false"]),
                ...
                vol.Optional("imageDescriptionLongThresholdLines"): vol.All(vol.Coerce(float), vol.Range(min=2, max=10)),
